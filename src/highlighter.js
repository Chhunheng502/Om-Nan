...
class OmNanHighlighter extends HTMLElement {
    constructor() {
      super();
      this.render();
    }
    ...
    render() {
      ...
      this.shadowRoot
        .getElementById("om-nan-highlighter")
  ...
  window.customElements.define("om-nan-highlighter", OmNanHighlighter);